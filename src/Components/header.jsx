...
const Header = ({headerImage, headerText, headerDesc, logo}) => {
  return (
    ...
    <div className="header-img d-none d-sm-block" style={{backgroundImage:`url(${headerImage})`}}>
        ...
        <div className="container-fluid container-md bg-opacity-90 shadow-sm mt-sm-0 my-md-5 bg-light d-flex rounded-top justify-content-start align-items-center px-5" style={{height:`200px`}}>
